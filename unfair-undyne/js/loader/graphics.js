...
graphics_loader
    ...
    .add("arrow", "/unfair-undyne/img/arrow.png")
    .add("heart", "/unfair-undyne/img/heart.png")
    .add("shield", "/unfair-undyne/img/shield.png")
    .add("spear", "/unfair-undyne/img/spear.png")
    .add("pike", "/unfair-undyne/img/pike.png")

    .add("by", "/unfair-undyne/img/by.png")
    .add("fairdyne", "/unfair-undyne/img/fairdyne.png")
    .add("ground1", "/unfair-undyne/img/ground1.png")
    .add("ground2", "/unfair-undyne/img/ground2.png")
    .add("ground3", "/unfair-undyne/img/ground3.png")
    .add("speechbubble", "/unfair-undyne/img/speechbubble.png")
    .add("un", "/unfair-undyne/img/un.png")
    .add("undyne", "/unfair-undyne/img/undyne.png")
    .add("undyne_breastplate", "/unfair-undyne/img/undyne_breastplate.png")
    .add("undyne_hair1", "/unfair-undyne/img/undyne_hair1.png")
    .add("undyne_hair2", "/unfair-undyne/img/undyne_hair2.png")
    .add("undyne_hair3", "/unfair-undyne/img/undyne_hair3.png")
    .add("undyne_hair4", "/unfair-undyne/img/undyne_hair4.png")
    .add("undyne_head1", "/unfair-undyne/img/undyne_head1.png")
    .add("undyne_head2", "/unfair-undyne/img/undyne_head2.png")
    .add("undyne_head3", "/unfair-undyne/img/undyne_head_annoyed.png")
    .add("undyne_head4", "/unfair-undyne/img/undyne_head_angry.png")
    .add("undyne_intro_hairless", "/unfair-undyne/img/undyne_intro_hairless.png")
    .add("undyne_leftarm", "/unfair-undyne/img/undyne_leftarm.png")
    .add("undyne_legs", "/unfair-undyne/img/undyne_legs.png")
    .add("undyne_rightarm", "/unfair-undyne/img/undyne_rightarm.png")
    .add("undyne_skirt", "/unfair-undyne/img/undyne_skirt.png")
